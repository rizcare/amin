...
var app  = new Framework7({
  ...
  id: 'id.rsumitrahusada.apam', // App bundle ID
  name: 'APAM Mitra Husada', // App name
  dialog: {
    title: 'Peringatan',
    buttonOk: 'Ya',
    buttonCancel: 'Tidak'
...
if (debug == '1') {
  ...
  function appReady(){
    ...
    document.addEventListener('resume', function(){
      ga('send', 'pageview' , {'location' : 'http://apam.rsumitrahusada.com/pasien-rest/index.html' });
    }, false);
...
//=================================================//
// Load data untuk halaman operasi.html               //
//=================================================//

$$(document).on('page:init', '.page[data-name="operasi"]', function(e) {
      ...
      closed: function () {
        ...
        app.request.post(apiUrl + 'apam/', {
          ...
          if(data.state == "notfound") {
            html += '<li><div class="item-content card">Tidak ada jadwal Operasi hari ini</div></li>';
          } else {
            html += '<center><div class="item-title" style="font-weight: bold;color: var(--f7-theme-color);">' + tanggal + '</div></center>';
            for(i=0; i<data.length; i++) {
              html += '<li>';
              html += ' <div class="item-content card" style="padding-left: 0px;margin-left: 16px;margin-right: 16px;">';
              html += '  <div class="item-inner" style="padding-right: 0px;padding-bottom: 0px;padding-top: 0px;">';
              html += '    <div class="card-header" style="font-size: 16px;font-weight: bold;background-color: var(--f7-theme-color);color: white;padding-right: 16px;padding-left: 16px;border-top-left-radius: 15px;border-top-right-radius: 15px;">'+ data[i]['no_rawat'] +'</div>';
              html += '    <div class="item-title">';
              html += '    <div class="card-content card-content-padding">';
              html += '    <div style="font-size: min(16px);color: var(--f7-theme-color);font-weight: 600;margin-bottom: 5px;">'+ data[i]['nm_dokter'] +'</div>';
              html += '    <div style="font-size: 13px;white-space: initial;"><i class="fa fa-bed" style="font-size:18px;color: #D61C4E;"></i>  ' + data[i]['nm_perawatan']+'</div>';
              if(data[i]['status'] == 'Selesai') {
                html += '    <div style="font-size:13px;"><i style="font-size:19px;color: #293462;" class="fa fa-clock-o"></i>  ' + data[i]['jam_mulai']+ ' WIB - ' + data[i]['jam_selesai']+' WIB</div>';
                html += '    <div style="font-size:13px; color: Green">Selesai</div>';
              } else if (data[i]['status'] == 'Proses Operasi') {
                html += '    <div style="font-size:13px;"><i style="font-size:19px;color: #293462;" class="fa fa-clock-o"></i>  ' + data[i]['jam_mulai']+ ' WIB</div>';
                html += '    <div style="font-size:13px; color: Red">Proses Operasi</div>';
              } else {
                html += '    <div style="font-size:13px;"><i style="font-size:19px;color: #293462;" class="fa fa-clock-o"></i>  -</div>';
                html += '    <div style="font-size:13px; color: Orange">Menunggu</div>';
              }    
              html += '   </div>'; 
              html += '   </div>'; 
              html += '  </div>';
  ...
  var today2 = ("0"+new Date().getDate()).slice(-2)+'-'+("0"+(new Date().getMonth()+1)).slice(-2)+'-'+new Date().getFullYear();
  ...
  app.request.post(apiUrl + 'apam/', {
    ...
    if(data.state == "notfound") {
      ...
      html += '<li><center><div class="item-inner" style="font-weight: bold;color: var(--f7-theme-color);">' + today2 + '</div></center></li>';
      for(i=0; i<data.length; i++) {
...
//=================================================//
// Load data untuk halaman antrianpoli.html               //
//=================================================//

$$(document).on('page:init', '.page[data-name="antrianpoli"]', function(e) {
    ...
    on: {
      closed: function () {
        ...
        app.request.post(apiUrl + 'apam/', {
          ...
          var html = '';
          if(data.state == "notfound") {
            html += '<li><div class="item-content card">Tidak ada jadwal Poliklinik hari ini</div></li>';
          } else {
            html += '<center><div class="item-title" style="font-weight: bold;color: var(--f7-theme-color);">' + tanggal + '</div></center>';
            for(i=0; i<data.length; i++) {
              html += '<li>';
              html += ' <div class="item-content card" style="padding-left: 0px;margin-left: 16px;margin-right: 16px;">';
              html += '   <div class="item-inner" style="padding-right: 0px;padding-bottom: 0px;padding-top: 0px;">';
              html += '   <div class="card-header" style="font-size: 16px;font-weight: bold;background-color: var(--f7-theme-color);color: white;padding-right: 16px;padding-left: 16px;border-top-left-radius: 15px;border-top-right-radius: 15px;">' + data[i]['nm_poli'] + '</div>';              
              html += '   <div class="item-title">';
              html += '   <div class="card-content card-content-padding">';
              html += '    <div style="font-size: min(16px);color: var(--f7-theme-color);font-weight: 600;margin-bottom: 5px;">' + data[i]['nm_dokter'] + '</div>';              
              html += '    <div class="row">';
              html += '    <div style="text-align : center;" class="col-25">';
              html += '    <p class="ma-0" style="font-size: 13px;">Kuota</p>';
              html += '    <h3 class="mt-0 mb-5">'+ data[i]['kuota']+'</h3>';
              html += '    </div>';
              html += '    <div style="text-align : center;" class="col-25">';
              html += '    <p class="ma-0" style="font-size: 13px;">Terdaftar</p>';
              html += '    <h3 class="mt-0 mb-5">'+ data[i]['cekin']['antrian']+'</h3>';
              html += '    </div>';
              html += '    <div style="text-align : center;" class="col-25">';
              html += '    <p class="ma-0" style="font-size: 13px;">Belum</p>';
              html += '    <h3 class="mt-0 mb-5">'+ data[i]['belumdilayani']['belum']+'</h3>';
              html += '    </div>';
              html += '    <div style="text-align : center;" class="col-25">';
              html += '    <p class="ma-0" style="font-size: 13px;">Dilayani</p>';
              html += '    <h3 class="mt-0 mb-5">'+ data[i]['sudahdilayani']['sudah']+'</h3>';
              html += '    </div>';
              html += '    </div>';
              if(data[i]['noterakhir']['no_reg']== null) {
                html += '    <div style="font-size:14px;margin-top: 10px;">Antrian Terakhir : Tidak ada</div>';
              } else {
                html += '    <div style="font-size:14px;margin-top: 10px;">Antrian Terakhir : <div style="color: Red; font-size:20px;font-weight: 500;">' + data[i]['noterakhir']['no_reg']+'</div></div>';
              }
  ...
  app.request.post(apiUrl + 'apam/', {
    ...
    var html = '';
    if(data.state == "notfound") {
      html += '<li><div class="item-content card">Tidak ada jadwal Poli hari ini</div></li>';
    } else {
      html += '<li><center><div class="item-inner" style="font-weight: bold;color: var(--f7-theme-color);">' + today2 + '</div></center></li>';
      for(i=0; i<data.length; i++) {
        ...
        if(data[i]['noterakhir']['no_reg']== null) {
          ...
          html += '    <div style="font-size:14px;margin-top: 10px;">Antrian Terakhir : <span style="color: Red; font-size:20px;font-weight: 500;">' + data[i]['noterakhir']['no_reg']+'</span></div>';
        }
        html += '   </div>';
        html += '  </div>';
        html += ' </div>';
...
$$(document).on('page:init', '.page[data-name="bookingdetail"]', function(e) {
  ...
  app.request.post(apiUrl + 'apam/', {
    ...
    for(i=0; i<data.length; i++) {
      ...
      html += '  <div class="item-inner">';
      html += '   <div class="item-title">';
	  html += '    <p align="center">Kode Booking:  <h2 align="center">' + no_rkm_medis + '' + no_reg + '</h2></p>';
      html += '    <div class="item-header">Nomor Kartu Berobat: ' + no_rkm_medis + '';
...
$$(document).on('page:init', '.page[data-name="kamar"]', function(e) {
  ...
  app.request.post(apiUrl + 'apam/', {
    ...
    var html = '';
    for(i=0; i<data.length; i++) {
      html += '<li><a href="/rawatinap/' + data[i]['idu'] + '/" class="item-link">';
      html += '  <div class="item-content card" style="padding-left: 0px;margin-left: 16px;margin-right: 16px;">   <div class="item-inner" style="padding-right: 0px;padding-bottom: 0px;padding-top: 0px;">';
      html += '  <div class="card-header" style="font-size: 17px;font-weight: bold;background-color: var(--f7-theme-color);color: white;padding-right: 16px;padding-left: 16px;border-top-left-radius: 15px;border-top-right-radius: 15px;">'+ data[i]['kelas'] +'</div>';
      html += '   <div class="item-title">';
      html += '    <div class="card-content card-content-padding">';
      html += '    <div class="row">';
      html += '     <div style="text-align : center;" class="col-50">';
      html += '     <p class="ma-0" style="font-size: 14px;font-weight: 600;">Tersedia</p>';
      html += '     <h2 class="mt-0 mb-5" style="color: green;">' + data[i]['kosong'] + '</h2>';
      html += '     </div>';
      html += '     <div style="text-align : center;" class="col-50">';
      html += '     <p class="ma-0" style="font-size: 14px;font-weight: 600;">Kapasitas</p>';
      html += '     <h2 class="mt-0 mb-5" style="color: red;">' + data[i]['total'] + '</h2>';
      html += '     </div>';
      html += '     </div> ';
      html += '   </div>';
      html += '  </div>';
      ...
      closed: function () {
        ...
        app.request.post(apiUrl + 'apam/', {
          ...
          if(data.state == "notfound") {
            ...
            for(i=0; i<data.length; i++) {
              html += '<li>';
              html += ' <div class="item-content card">';
              html += '  <div class="item-media"><img src="' + webapps_url +'penggajian/pages/pegawai/photo/' + data[i]['kd_dokter'] + '.jpg" width="50" style="border-radius: 50%; margin-top: 15px;"></div>';
              html += '  <div class="item-inner">';
              html += '   <div class="item-title">';
...
$$(document).on('page:init', '.page[data-name="rawatinap"]', function(e) {
  ...
  app.request.post(apiUrl + 'apam/', {
    ...
    for(i=0; i<data.length; i++) {
      ...
      html += '  <div class="item-inner">';
      html += '   <div class="item-title">';
      html += '    <div class="item" style="font-size: 15px;font-weight: bold;color: var(--f7-theme-color);">' + data[i]['nm_bangsal'] + ' - ' + data[i]['kd_kamar'] + '</div>';
      html += '    <div class="item" style="font-size: 15px; color: var(--f7-theme-color);">' + data[i]['kelas'] + '</div>    ';
      if(data[i]['status'] == 'ISI') {
        html += '                    <div class="item">Status: <span style="color: Red;font-weight: 500;">Terisi</span></div>';
      } else if(data[i]['status'] == 'DIBERSIHKAN') {
        html += '                    <div class="item">Status: <span style="color: Dodgerblue;font-weight: 500;">Di Bersihkan</span></div>';
      } else if(data[i]['status'] == 'DIBOOKING') {
        html += '                    <div class="item">Status: <span style="color: Orange;font-weight: 500;">Di Booking</span></div>';
      } else {
        html += '                    <div class="item">Status: <span style="color: Green;font-weight: 500;">Kosong</span></div>';
      }
...
$$(document).on('page:init', '.page[data-name="profil"]', function(e) {
  ...
  app.request.post(apiUrl + 'apam/', {
    ...
    document.getElementById("fotone").src = data['foto'];
      ...
      $$('body').on('change', '.klinik-list', function() {
        ...
        app.request.post(apiUrl + 'apam/', {
          ...
          for(i=0; i<data.length; i++) {
            ...
            html += '    <div class="item-inner">';
            html += '      <div class="item-title">' + data[i]['nm_dokter'] + '</div>';
			html += '      <div class="item-title">[' + data[i]['jam_mulai'] + '-' + data[i]['jam_selesai'] + ']</div>';
            html += '    </div>';
            html += '  </label>';
            html += '</li>';
...
$$('.logout-btn').on('click', function () {
  app.dialog.confirm('Anda yakin ingin keluar?', function () {
    app.dialog.alert('Anda telah keluar sepenuhnya dari sistem!');
    localStorage.removeItem("no_rkm_medis");
    //localStorage.removeItem("layout");
    //localStorage.removeItem("color");
